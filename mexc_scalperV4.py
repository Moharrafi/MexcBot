...
log = logging.getLogger("ScalperV4")
...
class ScalperBotV4:
    ...
    def run(self):
        log.info("=" * 60)
        log.info(f"  MEXC SCALPER V4 — {'DRY RUN' if self.dry_run else 'LIVE TRADING'}")
